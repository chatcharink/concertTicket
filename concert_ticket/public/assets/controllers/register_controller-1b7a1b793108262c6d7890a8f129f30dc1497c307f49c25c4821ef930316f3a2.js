...
export default class extends Controller {
    ...
    changeWorkshop(){
        let workshop = document.getElementById("participate-checkbox-1");
        let div_workshop = document.getElementById("div-radio-workshop");

        if (workshop.checked){
            let gg_form = document.createElement("a");
            gg_form.id = "gg-form-link";
            gg_form.classList.add("text-sm/6");
            gg_form.classList.add("font-athiti");
            gg_form.classList.add("font-medium");
            gg_form.classList.add("text-red-900");
            gg_form.href = "https://forms.gle/M3pPvjmD5M2BLBxJ9";
            gg_form.target = "_blank";
            gg_form.rel = "noopener noreferrer";
            div_workshop.appendChild(gg_form);
        }
        else
        {
            let link_gg_form = document.getElementById("gg-form-link");
            if (link_gg_form !== null){
                link_gg_form.remove();
            }
        }
    }
    ...
    submitRegister(event){
        ...
        let participate_invalid_text = document.getElementById("participate-invalid-msg");
        let participate_workshop = document.getElementById("participate-checkbox-1");
        let participate_concert = document.getElementById("participate-checkbox-2");
        ...
        if (participate_workshop.checked || participate_concert.checked){
            participate_invalid_text.style.display = "none";
            valid_data = true;
        }
        else
        {
            participate_invalid_text.style.display = "block";
            valid_data = false;
        }
