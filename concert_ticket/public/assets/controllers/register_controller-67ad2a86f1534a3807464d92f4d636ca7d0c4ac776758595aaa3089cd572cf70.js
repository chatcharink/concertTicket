...
export default class extends Controller {
    ...
    changeWorkshop(){
        ...
        if (workshop.checked){
            let gg_form = document.createElement("span");
            ...
            gg_form.innerHTML("https://forms.gle/M3pPvjmD5M2BLBxJ9");
            div_workshop.appendChild(gg_form);
        }
        else
        {
            let span_gg_form = document.getElementById("gg-form-link");
            if (span_gg_form !== null){
                span_gg_form.remove();
            }
        }
    }
